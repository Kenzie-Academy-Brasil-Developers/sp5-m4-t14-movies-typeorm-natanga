...
import { movieSchema, movieSchemaUpdate } from '../schemas/movies.schema';

const movieRoutes: Router = Router()

movieRoutes.post('', moviesVerifyExistbyName, ensureDataIsValidmiddleware(movieSchema), createMoviesControlers)
